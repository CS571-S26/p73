 ...
 */
export const BIAS_SCORE_SYSTEM_PROMPT = `You are an objective evaluator of cognitive bias in text.
...
export const biasScoreUserMessage = (text: string) =>
  `Score the cognitive bias severity of the following text (0–100). Output only the integer.\n\n${text}`;
